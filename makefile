...
C_CPP_COMMON += -Wattribute-alias -s -fomit-frame-pointer -fsingle-precision-constant #-Wno-conversion
#
...
CPP_COMMON += -fno-threadsafe-statics -Wnoexcept -Wsign-promo -nostdinc++ #-Werror=old-style-cast
# 
